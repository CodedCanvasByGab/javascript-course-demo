...
function calculateAverage(grade0, grade1, grade2, grade3, grade4, grade5, grade6, grade7){
    const sum = grade0 + grade1 + grade2 + grade3 + grade4 + grade5 + grade6 + grade7;
    const average = sum / 8 ;
    return average;
}

function findHighestGrades(grades){
...
function findLowestGrades(grades){
